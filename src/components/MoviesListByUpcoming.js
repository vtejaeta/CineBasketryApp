...
import { getMoviesByUpcoming } from "../actions/";

class MoviesListByUpcoming extends Component {
  state = {
  ...
  handlePageId = async (id) => {
    ...
    this.props.getMoviesByUpcoming(this.state.pageId);
  };
...
export default connect(mapStateToProps, { getMoviesByUpcoming })(
  MoviesListByUpcoming
);
